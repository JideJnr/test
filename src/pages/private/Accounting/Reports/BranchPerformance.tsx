...
import { IBranchPerformanceReport } from "@/interfaces/iPosting";

const columnHelper = createColumnHelper<IBranchPerformanceReport>();

const { RangePicker } = DatePicker;
const columns: ColumnDef<IBranchPerformanceReport>[] = [
...
const BranchPerformanceReports = () => {
  const {
    postingStore: { loading, getBranchLoanPerformance, branchPerformance },
  } = useStore();
    ...
    <div>
      <div className="flex flex-col md:flex-row md:justify-between md:items-center border-b">
        <PageTitle
          ...
          subTitle="View all branch performance reports"
          showAdd={false}
        ...
        <div className="flex items-center flex-col sm:flex-row gap-2 mt-8">
          ...
          <div className="flex gap-2 md:gap-x-4 md:ml-auto">
            ...
            <Button
              ...
              size="large"
              onClick={async () => {
                await getBranchLoanPerformance(
...
export default BranchPerformanceReports;
